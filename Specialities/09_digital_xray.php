...
<div class="container padding-top-bottom-sec">
    <div class="row">
        ...
        <div class="col-lg-12">
            <h1 class="blue-color fs-3">When and Why Digital X-Rays are Recommended:</h1>
        </div>
        <div class="col-lg-12">
            <p class="ptag-grey-color mt-2 mb-2">
              Digital X-rays are essential for diagnosing bone fractures, monitoring healing, and detecting chest conditions. They are quick, non-invasive, and provide critical insights into various internal structures, making them indispensable in emergency and routine medical care.
            <ul>
